...
function rotateFunction() {
  ...
  window.setTimeout((() => {
    ...
    if (random === 1) { //6
      ...
      const player = new Vimeo.Player(doglalala);
      player.play();
      // doglalala.play();
      setTimeout(() => {
      ...
      // greenLight.play();
      const player = new Vimeo.Player(greenLight);
      player.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(TONY2);
      player.play();
      // TONY2.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(CHUNG_HUA);
      player.play();
      // CHUNG_HUA.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(proudOf);
      player.play();
      // proudOf.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(savings);
      player.play();
      // savings.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(Chou);
      player.play();
      // Chou.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(needle);
      player.play();
      // needle.play();
      setTimeout(() => {
      ...
      const player = new Vimeo.Player(WinStock);
      player.play();
      // WinStock.play();
      setTimeout(() => {
